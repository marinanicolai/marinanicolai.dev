      ...
      <div className="text-left">
        <Fade left duration={2000}>
          <StaticImage
            ...
            placeholder="blurred"
            alt="Marina-Nicolai-profile"
          />
        </Fade>
      </div>
      <div className="text-right p20">
        <Fade right duration={2000}>
          <h1 className="p20 ml-3 text-coolGray-900 dark:text-white text-3xl sm:text-5xl lg:text-5xl leading-none font-extrabold tracking-tight mb-4">
            Hello! I'm <span>Marina</span>,
          </h1>
        </Fade>
        <Fade right duration={3000}>
          <p className="intro p20 text-coolGray-600 dark:text-coolGray-400 prose leading-6">
            ...
            combining my software engineering skills with my and experience.
